...
const products = [
  ...
  },
  {
    id: 3,
    name: "Algodão",
    description: "Embalagens econômicas",
    price: "A partir de R$ 5,90",
    image: "☁️",
    color: "bg-gray-100"
  },
  {
    id: 4,
    name: "Termômetros",
    description: "Digital e infravermelho",
    ...
    <section className="py-12 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between mb-8">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-800">Materiais de Primeiros Socorros</h2>
